...
assert.equal(roleHasPermission("ADMIN", "campaign:approve"), true);
assert.equal(roleHasPermission("DOCTOR", "patient:import"), false);
assert.equal(roleHasPermission("DOCTOR", "user:manage"), false);
assert.equal(roleHasPermission("DOCTOR", "campaign:prepare"), false);
assert.equal(roleHasPermission("DOCTOR", "campaign:approve"), false);
assert.equal(roleHasPermission("RECEPTIONIST", "patient:import"), true);
assert.equal(roleHasPermission("RECEPTIONIST", "campaign:prepare"), true);
assert.equal(roleHasPermission("RECEPTIONIST", "campaign:approve"), false);
assert.equal(roleHasPermission("MANAGER", "audit:read"), true);
assert.equal(roleHasPermission("MANAGER", "user:read"), true);
assert.equal(roleHasPermission("MANAGER", "campaign:prepare"), true);
assert.equal(roleHasPermission("MANAGER", "campaign:approve"), true);
assert.equal(roleHasPermission("MANAGER", "invitation:create"), false);
assert.equal(roleHasPermission("STAFF", "billing:read"), false);
assert.equal(roleHasPermission("STAFF", "campaign:prepare"), false);
assert.equal(roleHasPermission("STAFF", "campaign:approve"), false);
assert.equal(roleHasPermission("STAFF", "tenant:switch"), true);
assert.equal(roleHasPermission("CLINICIAN", "patient:update"), true);
assert.equal(roleHasPermission("CLINICIAN", "campaign:prepare"), false);
assert.equal(roleHasPermission("CLINICIAN", "campaign:approve"), false);
